...
--
-- Host: 127.0.0.1
-- Generation Time: 18 Jul 2017 pada 20.01
...
(103, 1499003368, '8L7WHV8M'),
(102, 1499003316, 'IAY6W6MJ'),
(101, 1499003240, '73FBLF5F'),
(100, 1499003130, 'CPHHIUXN'),
(99, 1499003100, 'LY3LITNI'),
(98, 1499003093, '4357HUNY'),
(97, 1499003022, '4QZ4IL33');
...
(7, 'asu', 1365990762, '<p>kuluk</p>', '629f267e017798360b4d5120965ea34b.jpg', 1, 4);
...
CREATE TABLE `dlmbg_gambar_iklan` (
  `id_gambar_iklan` int(10) NOT NULL,
...
CREATE TABLE `dlmbg_komentar_iklan` (
  `id_komentar_iklan` int(10) NOT NULL,
  `id_iklan` int(10) NOT NULL,
  `id_member` int(10) NOT NULL,
...
(6, 'SYAMSUL BAHRI', 'syamsulbahri394@gmail.com', 'Pettarani 3b No.30D Makassar', '082293144699', '082246415501', 'L', 1494881944, '', '037d90adde1260fe69b5ece4ff495cb3', 0, '', ''),
(7, 'ccc', 'ccc@gmail.com', 'ccc', '098', '0987', 'P', 1494974773, '', '2504002450fd951b92c3ac4ad144a3ea', 0, '', '');
...
CREATE TABLE `dlmbg_pesan` (
  `id_pesan` int(40) NOT NULL,
...
CREATE TABLE `dlmbg_pesan_admin` (
  `id_pesan_admin` int(40) NOT NULL,
  `id_pengirim` int(30) NOT NULL,
  `isi` text NOT NULL,
  `waktu` int(20) NOT NULL,
...
--
-- Indexes for table `dlmbg_admin`
--
ALTER TABLE `dlmbg_admin`
  ADD PRIMARY KEY (`id_admin`);

--
-- Indexes for table `dlmbg_artikel`
--
ALTER TABLE `dlmbg_artikel`
...
--
-- Indexes for table `dlmbg_file`
--
ALTER TABLE `dlmbg_file`
  ADD PRIMARY KEY (`id_file`);

--
-- Indexes for table `dlmbg_gambar_iklan`
--
ALTER TABLE `dlmbg_gambar_iklan`
  ADD PRIMARY KEY (`id_gambar_iklan`);

--
-- Indexes for table `dlmbg_iklan`
--
ALTER TABLE `dlmbg_iklan`
  ADD PRIMARY KEY (`id_iklan`);

--
-- Indexes for table `dlmbg_kategori`
--
ALTER TABLE `dlmbg_kategori`
  ADD PRIMARY KEY (`id_kategori`);

--
-- Indexes for table `dlmbg_komentar_iklan`
--
ALTER TABLE `dlmbg_komentar_iklan`
  ADD PRIMARY KEY (`id_komentar_iklan`);

--
-- Indexes for table `dlmbg_lokasi`
--
ALTER TABLE `dlmbg_lokasi`
  ADD PRIMARY KEY (`id_lokasi`);

--
-- Indexes for table `dlmbg_member`
--
ALTER TABLE `dlmbg_member`
...
--
-- Indexes for table `dlmbg_pesan`
--
ALTER TABLE `dlmbg_pesan`
  ADD PRIMARY KEY (`id_pesan`);

--
-- Indexes for table `dlmbg_pesan_admin`
--
ALTER TABLE `dlmbg_pesan_admin`
  ADD PRIMARY KEY (`id_pesan_admin`);
...
--
ALTER TABLE `captcha`
  MODIFY `captcha_id` bigint(13) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=104;
--
-- AUTO_INCREMENT for table `dlmbg_admin`
--
ALTER TABLE `dlmbg_admin`
  MODIFY `id_admin` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `dlmbg_artikel`
--
ALTER TABLE `dlmbg_artikel`
...
--
-- AUTO_INCREMENT for table `dlmbg_file`
--
ALTER TABLE `dlmbg_file`
  MODIFY `id_file` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `dlmbg_gambar_iklan`
--
ALTER TABLE `dlmbg_gambar_iklan`
  MODIFY `id_gambar_iklan` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
-- AUTO_INCREMENT for table `dlmbg_iklan`
--
ALTER TABLE `dlmbg_iklan`
  MODIFY `id_iklan` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
--
-- AUTO_INCREMENT for table `dlmbg_kategori`
--
ALTER TABLE `dlmbg_kategori`
  MODIFY `id_kategori` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT for table `dlmbg_komentar_iklan`
--
ALTER TABLE `dlmbg_komentar_iklan`
  MODIFY `id_komentar_iklan` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `dlmbg_lokasi`
--
ALTER TABLE `dlmbg_lokasi`
  MODIFY `id_lokasi` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `dlmbg_member`
--
ALTER TABLE `dlmbg_member`
...
--
-- AUTO_INCREMENT for table `dlmbg_pesan`
--
ALTER TABLE `dlmbg_pesan`
  MODIFY `id_pesan` int(40) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `dlmbg_pesan_admin`
--
ALTER TABLE `dlmbg_pesan_admin`
  MODIFY `id_pesan_admin` int(40) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
